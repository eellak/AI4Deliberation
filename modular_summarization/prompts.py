...
LAW_NEW_JSON_PROMPT = (
    "Το παρακάτω κείμενο εισάγει νέες διατάξεις, ορισμούς ή ρυθμίσεις χωρίς να τροποποιεί προϋπάρχοντες νόμους. Επιστρέφεις **μόνο** έγκυρο JSON, κανέναν άλλον χαρακτήρα πριν ή μετά:\n"
    "{\n"
