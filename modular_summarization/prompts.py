...
LAW_MOD_JSON_PROMPT_W_MDATA = (
    ...
    διατάξεις νόμου. Επιστρέφεις **μόνο** έγκυρο JSON, κανέναν άλλον χαρακτήρα πριν ή μετά.  
    Αν το άρθρο αλλάζει ΠΕΡΙΣΣΟΤΕΡΕΣ από μία διατάξεις, επέστρεψε **λίστα** από τέτοια αντικείμενα (έως 5).  
    Διαφορετικά επέστρεψε ένα μόνο αντικείμενο.
