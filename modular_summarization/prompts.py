...
STAGE2_CHAPTER_PROMPT = (
    "[SCHEMA:CHAPTER_SUM] \n"
    "Οι παρακάτω λίστα περιέχει σύντομες περιλήψεις άρθρων του ίδιου ΚΕΦΑΛΑΙΟΥ:\n"
    "{chapter_summaries}\n\n"
    "Κάθε άρθρο είτε τροποποιεί/καταργεί υπάρχουσες διατάξεις είτε εισάγει νέες. "
...
# ---------------------------------------------------------------------------
# Simplified Stage 1 summary prompts (single-field JSON)
# ---------------------------------------------------------------------------
...
{{
  \"summary\": \"<περίληψη έως 20 λέξεις>\"
}}

ΟΔΗΓΙΕΣ ΓΙΑ summary:
- Η πρώτη πρόταση αναφέρει ρητά τον νόμο που τροποποιείται και τι αλλάζει.
- Περιέγραψε την ουσία και τον στόχο της αλλαγής.
- Μην αναφέρεις κωδικούς ΦΕΚ ή αρίθμηση άρθρων.
- Πρέπει να είναι 1-2 προτάσεις και έως 20 λέξεις συνολικά.
...
PROMPTS: Dict[str, str] = {
    ...
    # Old detailed-schema prompts (kept for legacy flows)
    "law_mod_json_mdata": LAW_MOD_JSON_PROMPT,
    "law_new_json_detailed": LAW_NEW_JSON_PROMPT,
    # New simplified single-field prompts
